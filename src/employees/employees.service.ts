  ...
  async create(dto: CreateEmployeeDto): Promise<Employee> {
        return this.dataSource.transaction(async (manager) => {
            ...
            try {
                ...
                if (
                    ...
                    throw new ConflictException('Email ou código de funcionário já em uso por outro registro');
                }
    ...
    async update(cpf: string, dto: UpdateEmployeeDto): Promise<Employee> {
        return this.dataSource.transaction(async (manager) => {
            ...
            if (dto.codigo_funcionario !== undefined) employee.codigo_funcionario = dto.codigo_funcionario;
