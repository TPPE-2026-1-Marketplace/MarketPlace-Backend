...
describe('PeopleController', () => {
    ...
    describe('registerPerson', () => {
        it('deve exigir JwtAuthGuard e RolesGuard', () => {
            const guards = Reflect.getMetadata(GUARDS_METADATA, controller.constructor.prototype.registerPerson);
    ...
    describe('registerUser', () => {
        it('não deve carregar metadados de guard específico', () => {
            const guards = Reflect.getMetadata(GUARDS_METADATA, controller.constructor.prototype.registerUser);
